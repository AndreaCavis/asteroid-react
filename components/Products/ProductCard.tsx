    ...
    <Link key={product.id} href={"/products/" + product.id} className="group bg-none rounded-md w-52 ">
      ...
      <div className=" group-hover:opacity-100">
        <div className="p-2 lg:w-52 md:w-44 sm:w-32 w-24 lg:text-lg md:text-base sm:text-sm text-xs">
          <h2 className="transition-opacity duration-200 opacity-50 group-hover:opacity-100 lg:text-xl md:text-lg sm:text-base text-sm font-semibold">
            {product.name}
          </h2>
          <h3 className="transition-all duration-100 opacity-50 group-hover:opacity-100 text-accent-foreground font-normal mb-1">
            {product.brand}
          </h3>
          <p className="text-accent-foreground font-semibold opacity-50 transition-all duration-0 group-hover:opacity-100">
